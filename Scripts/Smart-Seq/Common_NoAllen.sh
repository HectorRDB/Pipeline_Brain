...
Rscript --vanilla --verbose  8-ConsensusClustering.R -n 32 -a FALSE -l $loc -o $out > 7bb.out 2>&1
echo "Nuclei dataset"
...
Rscript --vanilla --verbose  8-ConsensusClustering.R -n 32 -a FALSE -l $loc -o $out > 7ba.out 2>&1
echo "Cell dataset"
