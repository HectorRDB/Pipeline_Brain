...
# Zinbwave
out_norm="/scratch/users/singlecell/MiniAtlas/data/rds/SMARTer_nuclei_MOp_norm.rds"
out_rd="/scratch/users/singlecell/MiniAtlas/data/rds/SMARTer_nuclei_MOp_zinbWs.rds"
