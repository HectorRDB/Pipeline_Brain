...
Rscript --verbose  Dune.R -n 20 -l $loc -o $out -S "1.8.50" -C "10" -m "k_25" -r $rsec > cells3.out 2>&1
...
Rscript --verbose  Dune.R -n 20 -l $loc -o $out -S "1.8.50" -C "10" -m "k_25" -r $rsec > nuclei3.out 2>&1
