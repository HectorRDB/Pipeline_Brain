...
Rscript --verbose  Dune.R -n 20 -l $loc -o $out -S "1.8.30" -C "15" -m "k_15" -r $rsec > cells2.out 2>&1
...
Rscript --verbose  Dune.R -n 20 -l $loc -o $out -S "1.8.30" -C "15" -m "k_15" -r $rsec > nuclei2.out 2>&1
