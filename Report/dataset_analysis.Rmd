...
libs <- c("here", "dplyr", "ggplot2", "tidyr", "stringr", "readr", "cowplot",
          "clusterExperiment", "mclust", "RColorBrewer", "progress", "merger",
          "png")
suppressMessages(
...
plot.new()
plot.window(0:1, 0:1)
rasterImage(readPNG(here("Figures", "SMART-Seq_workflow.png")), 0, 0, 1, 1)
```
...
allen_ARI <- function(clus, allen) {
  inds <- clus == -1
  mclust::adjustedRandIndex(clus[!inds], allen[!inds])
}
